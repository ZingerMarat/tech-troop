...
//Exercise 1
// const result = users.map(u => {return {email: u.email, companyName: u.company.name}})
// console.log(result);



//Exercise 2
// const result = users.filter(u => '5' == u.address.zipcode[0])
// console.log(result);



//Exercise 3
// const result = users.filter(u => '5' == u.address.zipcode[0]).map(u => {return u.id})
// console.log(result);



//Exercise 4
// const names = users.filter(u => "C" === u.name[0]).map(u => u.name)
// console.log(names);
...
//Exercise 6
// const result = users.find(u => u.address.suite === 'Apt. 950').company.name
// console.log(result);
...
// const result = studentScores.reduce((scores, s) => {
//     if ( 90<= s && s<=100){
...
const totalCost = cartItems.reduce((acc, i) => {
    return (i.price * taxRates[i.category] + i.price) * i.quantity + acc
}, 0)
